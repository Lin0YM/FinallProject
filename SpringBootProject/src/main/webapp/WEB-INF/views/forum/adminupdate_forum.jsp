...
<body>
	...
	<div class="container">
		...
		<form action="<c:url value='/adminforum/saveForumAdmin'/>"
			method="POST">
			...
			<input type="text" name="theme" value="${forum.theme}"
				class="form-control mb-10 col-10" maxlength="50">
			...
			<a
				href="<c:url value='/adminforum/admindeleteForum?id=${forum.id}'/>"class="btn btn-danger">刪除</a> 
		...
		<a href="<c:url value='/adminforum/'/>"> 返回主題列表</a>
