		...
		<article class="article">
			...
			<div class="tablediv">
				...
				<table id="table_id" class="display">
					...
					<tbody>
						<c:forEach items='${groupList}' var='afa'>
							<tr>
								<td>
									<img src='<c:url value='/showshopimagebyname?shopname=${afa.groupShopName}' />' width="100"></td>
								<td>
									<p>${afa.groupId}</p>
								</td>
								<td>
								...
								<td>
									...
									<a
									href="<c:url value='/groupBuybuyerATTTTT?groupId=${afa.groupId}&buyer=${buyer}'/>">參與團購</a>
									<%-- 						<a href="<c:url value='/adminSee?groupId=${afa.groupId}'/>">觀看細節</a> --%>
								</td>
							</tr>
						</c:forEach>
					</tbody>
