...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav">
		...
		<%-- 		<div><a href="<c:url value='/adminMain' />">回管理員頁面</a></div> --%>
								...
								<c:forEach items='${adminFindAll}' var='afa'>
									<tr>
										...
										<td>
											...
											<a href="<c:url value='/groupBuyadminUpdate?groupId=${afa.groupId}'/>">修改</a>
											<%-- 						<a href="<c:url value='/adminSee?groupId=${afa.groupId}'/>">觀看細節</a> --%>
											<a href="<c:url value='/groupBuyadminDelete?groupId=${afa.groupId} '/>">刪除</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
