...
<%
    // === 接收電子地圖回傳值 ===
    String s_stName = request.getParameter("st_name");
    String s_stAddr = request.getParameter("st_addr");
...
<body>
	...
	<div class="tablediv">
		<form action="<c:url value='/singlebuy/goorder' />"  method="POST">
			<table class="itemtable1">
				<tr>
					<td class="paytd">
						...
						<span>地址：</span><input type="text" size="30" id="address" name="address" value="${address}" required>
					</td>
					<td>
						...
						<input type="submit" value="下訂" id="orderbtn">
					</td>
				</tr>
			</table>
		</form>
