                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        $.each(response,function(index,data){
							...
							let url = "http://localhost:9090/springapp/singlebuy/itempage?itemid=" + data[0];
							console.log(url);
                            content += '<td class="itemtd">'
                            		+ '<a href="http://localhost:9090/springapp/singlebuy/itempage?itemid=' + data[0] + '">'
                            		+ '<div class="image animated fadeIn">'
                            		+ '<img class="itemimg" src="http://localhost:9090/springapp/singlebuy/showitemimage?itemid=' + data[0] + '">'
        							+ '<div class="image__overlay">'
        							+ '<i class="fas fa-search"></i>'
        							+ '</div>'
        							+ '</div>'
        							+ '</a>'
        							+ '<p class="pricep">NT$ ' + data[2] + '</p>'
        							+ '<p>' + data[1] + '</p>'
        							+ '</td>';
                            ...
                            if(index == 0 || index % 4 == 0 ){
                            	...
                            	$('#itemtable tr:last').append(content);
                            }
                        })
                    },error:function(xhr){
