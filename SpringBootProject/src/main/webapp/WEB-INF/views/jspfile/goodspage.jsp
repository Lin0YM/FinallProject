  ...
  <main>
    <div class="card">
      ...
      <div class="card__body">
        <div class="half">
          <div class="image">				  
				<img  id="blah" src="<c:url value='/goods/getPicture/${newgood.id}' />" alt="" />
          </div>
        </div>
        <div class="half">
          
          <span class="stock"><i class="fa fa-pen"></i> 物品名稱:</span><span>${newgood.goodsName}</span><br><br>	
          <span class="stock"><i class="fa fa-pen"></i> 物品類別:</span><span>${newgood.goodsType}</span><br><br>  
           <span class="stock"><i class="fa fa-pen"></i> 商品數量:</span><span>${newgood.goodsNum}</span><br><br>     
           <span class="stock"><i class="fa fa-pen"></i> 商品單價:</span><span>${newgood.goodsPrice}元</span><br><br> 
           <span class="stock"><i class="fa fa-pen"></i> 商品總金額:</span><span>${newgood.sumPrice}元</span><br><br> 
           <span class="stock"><i class="fa fa-pen"></i> 發布會員:</span><span>${member3.username}</span><br><br> 
           <span class="stock"><i class="fa fa-pen"></i> 物品簡介:</span><span>${newgood.goodsInt}</span><br><br> 
