...
<body>
	...
	<tr>
		<div class="goodslist">
		<ul id="menu">
		  <li><a href="<c:url value='/goods/products/add' />">${subtitle1}</a></li>
		  <li><a href="<c:url value='/goods/goodslist' />">${subtitle2}</a></li>
		  <li><a href="<c:url value='/goods/Toshopcarlist' />">${subtitle3}</a></li>
		  <li><a href="<c:url value='/goods/ordergoodslist' />">${subtitle4}</a></li>
		  <li><a href="<c:url value='/goods/goodsorderstatus' />">${subtitle5}</a></li>
		  <li><a href="<c:url value='/goods/findscopelists' />">${subtitle6}</a></li>
		  <li><a href="<c:url value='/goods/checkg' />">${subtitle7}</a></li>
		</ul>
		</div>
		</tr>
    	<div class="thumbnail">
