                                    ...
                                    <tbody>
                                        <c:forEach items='${goodsbymember}' var='good'>   
											<tr>
												...
												<input type="hidden" name="getid" value="${good.id}" >
												...
												<td>${good.sumPrice}</td>
												<td>${good.goodsInt}</td>
												<td>${good.uploadMember}</td>
												<td><a href="<c:url value='/admin/uploadgoodsupdate?id=${good.id}' />">修改</a></td>
												<td><a href="<c:url value='/admin/uploadgoodsdelete?id=${good.id}' />">刪除</a></td>
											</tr>
										</c:forEach>
                                    </tbody>
                                </table>
