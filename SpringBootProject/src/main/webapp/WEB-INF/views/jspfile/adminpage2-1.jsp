...
<script type="text/javascript">
    ...
    function fn(){
    	...
    	var nowDate=nowyear+'-'+nowmonth+'-'+nowday+' '+nowHR+':'+nowMM+':'+nowSS;
    	...
    	document.getElementById("orderitemname").value=goods[index];
    	document.getElementById("orderitemtotalcount").value=increasenum;
    	document.getElementById("orderitemfinishdate").value=nowDate;
    	document.getElementById("orderuseraddress").value=Info[index];
    ...
    function returnhome(){
		location.href="<c:url value='/addminfind/orderrecord' />";
    }
		...
		<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">修改商品下單資訊</h1>

                                <form action="<c:url value='/admin/ordergoodsupdateinfo' />" method="get" >
                                		<div class="info">
                                		<p>商品編號:</p>
                                		<p><input id="id" name="id" value="${changeordergoodslist.orderlistid}"></p>
                                		<p>商品類別:</p>
				                        ...
				                        <p>商品數量:</p>
				                        <p><input id="orderitemtotalcount" name="orderitemtotalcount" type="text" value="${changeordergoodslist.orderitemtotalcount}" /></p>
				                        <p>商品單價:</p>
				                        <p><input id="orderitemsingleprice" name="orderitemsingleprice" type="text" value="${changeordergoodslist.orderitemsingleprice}" /></p>
				                        <p>下單時間:</p>
				                        <p><input id="orderitemfinishdate" name="orderitemfinishdate" type="text" value="${changeordergoodslist.orderitemfinishdate}" /></p>
				                        </div><div class="info1">
				                        <p>下單狀態:</p>
				                        <select name="goodsorderType" id="goodsorderType">
				                            <option value="請等候賣家....">請等候賣家....</option>
				                            <option value="確認出貨">確認出貨</option>
				                            <option value="取消出貨">取消出貨</option>
				                            <option value="完成評論">完成評論</option>
				                        </select>
				                        <p>上架會員:</p>
				                        <p><input id="goodsuploadusername" name="goodsuploadusername" type="text" value="${changeordergoodslist.goodsuploadusername}" /></p>
				                        <p>下訂會員:</p>
				                        <p><input id="orderitemusername" name="orderitemusername" type="text" value="${changeordergoodslist.orderitemusername}" /></p>
				                        <p>下訂住址:</p>
				                        <p><input id="orderuseraddress" name="orderuseraddress" type="text" value="${changeordergoodslist.orderuseraddress}" /></p>
