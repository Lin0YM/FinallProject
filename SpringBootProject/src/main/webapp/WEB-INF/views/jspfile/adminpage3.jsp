                                    ...
                                    <tbody>
                                        <c:forEach items='${ordergoodslist}' var='good'>   
											<tr>
												...
												<td>${good.goodsscope}</td>
												<td><a href="<spring:url value='/admin/scopeupdate?id=${good.orderlistid}' />">修改</a></td>
												<td><a href="<spring:url value='/admin/scopedelete?id=${good.orderlistid}' />">刪除</a></td>
											</tr>
										</c:forEach>
                                    </tbody>
                                </table>
