...
public class MemberAddNew2Validator implements Validator {
	
	MemberService memberService;
	private boolean check;
	
	public MemberAddNew2Validator() {
		super();
	}
...
//	}
	...
	@Autowired
	public MemberAddNew2Validator(MemberService memberService) {
		super();
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmpty(errors, "name", "member.name.empty", "姓名欄位不正確");
		ValidationUtils.rejectIfEmpty(errors, "phonenumber", "member.phonenumber.empty", "電話欄位不正確");
